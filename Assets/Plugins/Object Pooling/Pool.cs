...
namespace ToolBox.Pools
{
    internal sealed class Pool
    {
        ...
        private static readonly Dictionary<GameObject, Pool> _prefabLookup = new Dictionary<GameObject, Pool>(20);
        private static readonly Dictionary<GameObject, Pool> _instanceLookup = new Dictionary<GameObject, Pool>(200);
        ...
        static Pool()
        {
            _poolsParent = new GameObject("Pool").transform;
        }

        public Pool(GameObject prefab)
        {
            _pool = new GameObject(prefab.name).transform;
            _pool.parent = _poolsParent;
        ...
        private Poolable CreateInstance()
        {
            ...
            instanceGameObject.transform.parent = _pool;
